                ...
                <div>
                    ...
                    <ul className="space-y-2 tracking-wide mt-8">
                        ...
                        <ul className='list-disc min-w-[100%]'>
                            ...
                            {
                                course.map(gory => {
                                    return <Link to={`/category/${gory.category}`}><li className="mx-[30%] min-w-[60%] category">
                                        {gory.category}
                                    </li></Link>
                                })
                            }
                    ...
                    <div className="grid gap-6 md:grid-cols- lg:grid-cols-3 mt-[5%]">
                        <div className="md:col-span-2 lg:col-span-2" >
                            <div className="h-full py-8 px-6 space-y-6 rounded-xl border border-gray-200 bg-white">
                                ...
                                <h5 class="hidden mt-4 text-xl font-bold text-black-600 lg:block">Skills you’ll gain</h5>
